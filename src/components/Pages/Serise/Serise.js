...
const Serise = () => {
    ...
    return (
        <div>
            <span className='pageTitle'>TV SERISE</span>
                <Genres
                type="tv" selectedGenres={selectedGenres} setPage={setPage} genrs={genrs} setGenrs={setGenrs} setSelectedGenres={setSelectedGenres}/>
